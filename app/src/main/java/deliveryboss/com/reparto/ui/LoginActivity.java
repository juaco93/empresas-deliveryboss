...
import deliveryboss.com.reparto.data.model.*;
...
public class LoginActivity extends AppCompatActivity {
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            //showProgress(true);
            Call<Empresa_repartidor> loginCall = mDeliverybossApi.loginUsuarioReparto(new LoginBody(e_mail, contrasena));
            loginCall.enqueue(new Callback<Empresa_repartidor>() {
                @Override
                public void onResponse(Call<Empresa_repartidor> call, Response<Empresa_repartidor> response) {
                    // Ocultar progreso
                    //showProgress(false);
                    // Procesar errores
                ...
                @Override
                public void onFailure(Call<Empresa_repartidor> call, Throwable t) {
                    //showProgress(false);
    ...
    private void displayFirebaseRegId() {
        ...
        String idusuario = pref1.getString(SessionPrefs.PREF_EMPRESA_REPARTIDOR_IDEMPRESA_REPARTIDOR,null);
